...
class SongMaster extends Model
{
     ...
     protected $fillable = [
       'speaker1_id','speaker2_id','category','subcategory','language','title','song','songtime','attach_pic','murli_date','publish_date','class_date','audience_place_event','audience_id','focus_id','message','message_label','attach_file','attach_file2','attach_label1','attach_label2','description','note2','description_label','note2_label','note3','note3_label','ispowerfull','status','ishome','inserted_by','updated_by','mobileuser_id','schedule_datetime'
    ];
    ...
    {
        return $this->belongsTo(Category::class, 'category_id')->select(['id', 'category_name','setforall_audio']);
    }
